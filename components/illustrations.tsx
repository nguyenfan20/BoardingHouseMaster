...
export function NoInvitesIllustration() {
  return (
    <svg viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Chưa có link mời nào">
      <circle cx="100" cy="80" r="60" fill="#F1F9F4" />
      <rect x="55" y="60" width="90" height="16" rx="8" fill="#FAFAF9" stroke="#B7E1C4" strokeWidth="2" />
      <circle cx="68" cy="68" r="5" fill="#2CA463" />
      <path d="M100 95 L100 120 M85 108 L100 120 L115 108" stroke="#178A54" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
}
...
export function AuthIllustration() {
  return (
    <svg viewBox="0 0 240 200" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Đăng nhập">
      <rect x="20" y="40" width="200" height="140" rx="16" fill="#F1F9F4" />
      <rect x="60" y="70" width="120" height="80" rx="10" fill="#FAFAF9" stroke="#B7E1C4" strokeWidth="2" />
      <circle cx="120" cy="100" r="16" fill="#2CA463" />
      <rect x="95" y="122" width="50" height="10" rx="5" fill="#DCF0E3" />
      <circle cx="200" cy="50" r="12" fill="#178A54" />
      <circle cx="35" cy="150" r="8" fill="#B7E1C4" />
    </svg>
  );
}
